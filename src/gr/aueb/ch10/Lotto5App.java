...
public class Lotto5App {
    ...
    public static void main(String[] args) {
        try (Scanner in = new Scanner(new File("/C:/Users/Nikos/Documents/Coding Factory/java/tmp/lotto5in.txt"));
             PrintStream ps = new PrintStream("/C:/Users/Nikos/Documents/Coding Factory/java/tmp/lotto5out.txt", StandardCharsets.UTF_8)) {
            ...
            Arrays.sort(numbers); //ταξινομηση
         ...
         * @return
         *      true, if the number of evens is greater than or equal to a threshold limit, false otherwise
         */
