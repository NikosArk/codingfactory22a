 ...
 * Αν μία δεξαμενή έχει λιγοτέρο από 1/4
 * καύσιμα τότε ανλαβει πορτοκαλί σήμα, ενώ αν και οι δύο
 * δεξαμενές έχουν < 1/4 τότε ανάβει κόκκινο σήμα.
 * Ο πιλότος ( χρήστης ) δίνει true ή false ανάλογα αν τανκ < 1/4 ή όχι, αντίστοιχα.
 */
